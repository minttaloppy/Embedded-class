...
void get_the_payload(char payload[]){
    ...
    BSP_LCD_DisplayStringAtLine(9,(uint8_t*) "Deaths : ");
    BSP_LCD_SetTextColor(LCD_COLOR_RED);
    BSP_LCD_DisplayStringAtLine(10,(uint8_t*) data[2]);
    BSP_LCD_SetTextColor(LCD_COLOR_YELLOW);

    BSP_LCD_DisplayStringAtLine(12,(uint8_t*) "UpdateTime : ");
...
void touchscreen_display(){
    ...
    BSP_LCD_SetFont(&Font16);
    BSP_LCD_DisplayStringAt(0, 15, (uint8_t *)"Covid Situation", CENTER_MODE);
